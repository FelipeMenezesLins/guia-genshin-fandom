...
let lista = ['Ayaka', 'Albedo', 'Alhaitham', 'Aloy', 'Arlecchino', 'Ayato', 'Baizhu', 'Child', 'Chiori', 'Clorinde', 'Cyno', 'Dehya', 'Diluc', 'Eula', 'Furina', 'Ganyu', 'Hutao', 'Itto', 'Jean', 'Kazuha', 'Keqing', 'Klee', 'Kokomi', 'Lyney', 'Mona', 'Nahida', 'Navia', 'Neuvillette', 'Nilou', 'Qiqi', 'Raiden', 'Shenhe', 'Tighnari', 'Viajante', 'Venti', 'Wriothesley', 'Wanderer', 'Xianyun', 'Xiao', 'YaeMiko', 'Yelan', 'Yoimiya', 'Zhongli', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'Neu', 'Wr', 'Wrio', 'Andarilho', 'Xi', 'Yae', 'Miko', 'Yae Miko', 'Yo', 'Zhong', 'Shogun', 'Ei', 'Rai']
